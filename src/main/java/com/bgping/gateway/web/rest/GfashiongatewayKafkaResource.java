...
@RestController
@RequestMapping("/api/gfashiongateway-kafka")
public class GfashiongatewayKafkaResource {
    private final Logger log = LoggerFactory.getLogger(GfashiongatewayKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public GfashiongatewayKafkaResource(KafkaProperties kafkaProperties) {
